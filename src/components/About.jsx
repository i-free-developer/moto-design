...
function AboutBrand() {
	return (
		<div className="scroll-fade-in border border-[0.02rem] lg:border-[0.04rem] rounded-[0.16rem] lg:rounded-[0.24rem] p-[0.32rem] lg:px-[0.64rem] lg:py-[0.48rem] mt-[1.28rem] lg:mt-[3.52rem] flex justify-between">
...
function EcosystemHeader() {
	return (
		<div className="scroll-fade-in mx-auto lg:text-center px-[0.32rem] lg:px-[0.96rem] mt-[2.16rem] lg:mt-[3.36rem] w-screen max-w-screen lg:max-w-[1920px] overflow-x-hidden">
