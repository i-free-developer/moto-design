...
export default function Career({isMobileDevice, smallScreenRatioDecimal}) {
	...
	return (
		<main className="mx-auto">
			...
			<section id="career" className="w-screen lg:max-w-[1920px] mx-auto px-[0.32rem] lg:px-[3rem] pt-[0.32rem] lg:pt-[3rem] lg:mt-[8rem] lg:mb-[3rem] overflow-x-hidden" onClick={closeDrawer}>
				<CareerHeader/>
				<CareerContenr/>
				<TimeLineCard/>
				<LifeAtMotoCard/>
